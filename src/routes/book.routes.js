...
bookRouter.get("/", authenticate, requireRole(["admin", "user"]), bookController.getAllBooks);
bookRouter.get("/:id", authenticate, requireRole(["admin", "user"]), bookController.getBookById);
